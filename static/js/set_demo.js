...
imgs.forEach(elem => {
  var code = `
    <div class="item">
      <div class="image-compare" class="twentytwenty-container">
...
vids.forEach(elem => {
  var code = `
    <div class="item">
      <video id="3d-photo-${elem}" autoplay muted loop playsinline>
        <source src="./static/videos/${elem}.mp4" type="video/mp4">
      </video>
    </div>`;
    content += code;
})
